...
public class AlphaNumericPercentageCheck {
		...
		private static double[] f_A_first = new double[] {0.611,	0.000,	0.121,	0.268};
		...
		private static double[] t_A_first = new double[] {0.635,	0.000,	0.116,	0.248};
		...
		private static double[] f_T_first = new double[] {0.469,	0.000,	0.105,	0.426};
		...
		private static double[] t_T_first = new double[] {0.564,	0.000,	0.134,	0.301};
	...
	public static char[] oneLoop(HashMap<Integer, double[]> hMap) {
		...
		double[] resultArr = new double[34];
